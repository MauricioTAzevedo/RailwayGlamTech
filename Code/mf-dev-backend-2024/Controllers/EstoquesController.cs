...
namespace mf_dev_backend_2024.Controllers
{
    public class EstoquesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EstoqueId,Produto,Quantidade")] Estoque estoque)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EstoqueId,Produto,Quantidade")] Estoque estoque)
        {
