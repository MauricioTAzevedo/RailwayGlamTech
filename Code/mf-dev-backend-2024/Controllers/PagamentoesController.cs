...
namespace mf_dev_backend_2024.Controllers
{
    public class PagamentoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PagamentoId,Valor,Status")] Pagamento pagamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PagamentoId,Valor,Status")] Pagamento pagamento)
        {
